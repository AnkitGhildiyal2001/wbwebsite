...
font-size: 1.25rem;
line-height: inherit;
white-space: nowrap;color: #8c8cf9;">WunderBrudis</div>
                    </a>
            ...
            <div class="container">
                <div class="columns has-text-centered">
                    ...
                    <div class="column is-8 is-offset-2 is-hero-caption is-centered">
                        <h1 class="title is-1">Die Plattform für Nano-Influencer</h1>
    ...
    <div id="services" class="section section-feature-grey is-medium is-skewed-sm">
        <div class="container is-reverse-skewed-sm">
            ...
            <div class="section-title-wrapper has-text-centered">
                ...
                <h4>And start making money the same day</h4>
            </div>
    ...
    <div id="features" class="section is-medium is-skewed-sm">
        <div class="container is-reverse-skewed-sm">
            ...
            <div class="section-title-wrapper has-text-centered">
                ...
                <h4>New integrations and features added everyday</h4>
            </div>
                        ...
                        <div class="navigation-tabs outlined-pills animated-tabs">
                                ...
                                <div class="columns is-vcentered">
                                    ...
                                    <div class="column is-6">
                                        <div class="inner-content">
                                            <h2 class="feature-headline is-clean">Create an incredible user and customer
                                                experience</h2>
                                            <p class="body-color">Lorem ipsum dolor sit amet, vim quidam blandit voluptaria no, has eu lorem
                                                convenire incorrupte. </p>
                                            <p class="body-color">Lorem ipsum dolor sit amet, vim quidam blandit voluptaria no, has eu lorem
                                                convenire incorrupte. Vis mutat altera percipit ad, ipsum prompta ius eu.
                                                Sanctus appellantur vim ea. Dolorem delicata vis te, aperiam nostrum ut per.
                                            </p>
                                            <div class="button-wrap">
                            ...
                            <div id="invoices" class="navtab-content">
                                <div class="columns is-vcentered">
                                    ...
                                    <div class="column is-6">
                                        <div class="inner-content">
                                            <h2 class="feature-headline is-clean">Create invoices seamlessly and get paid
                                                incredibly fast</h2>
                                            <p class="body-color">Lorem ipsum dolor sit amet, vim quidam blandit voluptaria no, has eu lorem
                                                convenire incorrupte. </p>
                                            <p class="body-color">Lorem ipsum dolor sit amet, vim quidam blandit voluptaria no, has eu lorem
                            ...
                            <div id="reporting" class="navtab-content">
                                <div class="columns is-vcentered">
                                    ...
                                    <div class="column is-6">
                                        <div class="inner-content">
                                            <h2 class="feature-headline is-clean">Get insight on your data and take managed
                                                decisions</h2>
                                            <p class="body-color">Lorem ipsum dolor sit amet, vim quidam blandit voluptaria no, has eu lorem
                                                convenire incorrupte. </p>
                                            <p class="body-color">Lorem ipsum dolor sit amet, vim quidam blandit voluptaria no, has eu lorem
            ...
            <div class="columns is-vcentered">
                ...
                <div class="column is-5 ">
                    <div class="side-feature-text">
                        ...
                        <p class="light-text">Lorem ipsum dolor sit amet, vim quidam blandit voluptaria no, has eu lorem
                            convenire incorrupte. Vis mutat altera percipit ad, ipsum prompta ius eu. Sanctus appellantur
                            vim ea. Dolorem delicata vis te, aperiam nostrum ut per.</p>
                        <div class="button-wrap">
                ...
                <div class="column is-6 is-offset-1">
                    <img class="featured-svg" src="{{ asset('new/assets/img/graphics/widgets/mini-widget-4-core.png')}}" data-base-url="{{ asset('new/assets/img/graphics/widgets/mini-widget-4')}}" data-extension=".png" alt="">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-4">
                        <div class="floating-circle levitate is-icon-reveal">
                            <img src="{{ asset('new/assets/img/graphics/icons/globe-core.svg')}}" data-base-url="{{ asset('new/assets/img/graphics/icons/globe')}}" data-extension=".svg" alt="">
                        </div>
                    ...
                    <div class="column is-4">
                        <div class="floating-circle levitate delay-2 is-icon-reveal">
                            <img src="{{ asset('new/assets/img/graphics/icons/cash-core.svg')}}" data-base-url="{{ asset('new/assets/img/graphics/icons/cash')}}" data-extension=".svg" alt="">
                        </div>
                        <div class="has-text-centered floating-text">
                    ...
                    <div class="column is-4">
                        <div class="floating-circle levitate delay-4 is-icon-reveal">
                            <img src="{{ asset('new/assets/img/graphics/icons/credit-card-core.svg')}}" data-base-url="{{ asset('new/assets/img/graphics/icons/credit-card')}}" data-extension=".svg" alt="">
                        </div>
                        <div class="has-text-centered floating-text">
    ...
    <footer class="footer footer-light-left">
        <div class="container">
            <div class="columns is-vcentered">
                <div class="column is-6">
                    <div class="mb-20">
                        <img class="small-footer-logo" src="{{ asset('new/assets/img/logos/bulkit-logo-g.png')}}" alt="">
                    </div>
                    <div>
