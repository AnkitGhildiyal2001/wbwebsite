...
<html lang="de">
  ...
  <head>
    ...
    <meta charset="utf-8">
    <title>Brands - WunderBrudis</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Wir schaffen Kundenbindung mit Nano-Influencern und geben deinem Word-of-Mouth-Marketing eine Plattform. Gratis starten!">
    ...
    <script id='pixel-script-poptin' src='https://cdn.popt.in/pixel.js?id=26ec06082c95b' async='true'></script>
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <section class="bg-dark text-light header-inner p-0 jarallax o-hidden" data-overlay data-jarallax data-speed="0.2">
      <img src="https://images.pexels.com/photos/7075/people-office-group-team.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="Image" class="jarallax-img opacity-30">
      <div class="container py-0 layer-2">
        <div class="row my-4 my-md-6" data-aos="fade-up">
          <div class="col-lg-9 col-xl-8">
            <h1 class="display-4">WunderBrudis für dein Business</h1>
            <p class="lead mb-0">Wir schaffen Kundenbindung mit Nano-Influencern und geben deinem Word-of-Mouth-Marketing eine Plattform.</p>
          </div>
        </div>
      </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row align-items-center justify-content-around">
          <div class="col-md-5 col-xl-6 mb-4 mb-md-0">
            <img src="{{ asset('images/static') }}/big-reach.jpg" alt="Image" class="rounded shadow-3d">
          </div>
          <div class="col-md-7 col-xl-6">
            <div class="row justify-content-center">
              <div class="col-xl-8 col-lg-10">
                ...
                <div class="my-3">
                  <span class="h1">Warum die WunderBrudis</span>
                </div>
                <p class="lead"><b>Passgenaue Influencer:</b><br>
                  Mithilfe unserer innovativen Plattform findest du die richtigen Influencer für deine Kampagne und deine Brand.

                  <br><b>Maximaler ROI:</b><br>
                  Wir garantieren dir und deiner Kampagne den maximalen Erfolg.

                  <br><b>Einfach WunderBrudis:</b><br>
                  Wir stehen dir als Community-Manager und ständige Ansprechpartner bei Fragen zur Seite.
                </p>
              </div></div>
              </div>
            </div>
    ...
    <section>
      <div class="container" data-aos="fade-up">
        <div class="row align-items-center justify-content-around">
          <div class="col-md-5 col-xl-6 mb-4 mb-md-0">
            <img src="{{ asset('images/static') }}/social-media-marketing.jpg" alt="Image" class="rounded shadow-3d">
          </div>
          <div class="col-md-7 col-xl-6">
            <div class="row justify-content-center">
              <div class="col-xl-8 col-lg-10">
                ...
                <div class="my-3">
                  <span class="h1">Unbegrenzte Möglichkeiten</span>
                </div>
                <p class="lead">The Sky ist the Limit – für das Marketing deiner Brand stehen dir praktisch unbegrenzte Möglichkeiten zur Verfügung. Du kannst über unsere innovative Plattform sowohl physische Produkte, als auch digitale Angebote vermarkten.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container" data-aos="fade-up">
        <div class="row align-items-center justify-content-around">
          <div class="col-md-5 col-xl-6 mb-4 mb-md-0">
            <img src="{{ asset('images/static') }}/Easyness-and-Shipping.jpg" alt="Image" class="rounded shadow-3d">
          </div>
          <div class="col-md-7 col-xl-6">
            <div class="row justify-content-center">
              <div class="col-xl-8 col-lg-10">
                ...
                <div class="my-3">
                  <span class="h1">Influencer Nano, Ergebnis Mega!</span>
                </div>
                <p class="lead">Nano-Influencing mit Mega-Ergebnis. Erhalte zu deinem Produkt durch unser Rezensionssystem authentisches und ehrliches Feedback sowie Reviews aus der Community. Sichere dir jetzt mehr Kunden!</p>
                <p></p>
              </div>
            </div>
            </div>
        ...
        <div style="padding-top: 90px;">
          ...
          <button type="button" onclick="Intercom('show');" class="btn btn-secondary btn-lg btn-block">🖥 Demo Termin vereinbaren</button>
        </div>
        </div>
      </div>
    </section>
