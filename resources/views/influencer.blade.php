...
<html lang="de">
  ...
  <head>
    ...
    <meta charset="utf-8">
    <title>Für Influencer</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Du möchtest coole Produkte erhalten und deinen Fans und Followern regelmäßig neuen Content bieten? Dann bist du hier genau richtig!">
  ...
  <!-- End Google Tag Manager (noscript) -->
          ...
          <div class="collapse navbar-collapse justify-content-end">
            <div class="py-2 py-lg-0">
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  <a href="/business" class="nav-link dropdown-toggle" data-toggle="dropdown-grid" aria-expanded="false" aria-haspopup="true">Unternehmen</a>
                </li>
                <li class="nav-item dropdown">
    ...
    <section class="bg-dark text-light header-inner p-0 jarallax o-hidden" data-overlay data-jarallax data-speed="0.2">
      <img src="https://images.pexels.com/photos/3616676/pexels-photo-3616676.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="Image" class="jarallax-img opacity-30">
      <div class="container py-0 layer-2">
        <div class="row my-4 my-md-6" data-aos="fade-up">
          <div class="col-lg-9 col-xl-8">
            <h1 class="display-4">Werde auch DU zum WunderBrudi!</h1>
            <p class="lead mb-0">Mit den WunderBrudis wirst auch du zum Influencer – auf dich und deine Community warten coole Produkte. Schon ab 500 Followern. No Joke!</p>
          </div>
        </div>
      </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row align-items-center justify-content-around">
          <div class="col-md-5 col-xl-6 mb-4 mb-md-0">
            <img src="{{ asset('images/static') }}/social-media-marketing-2-1.jpg" alt="Image" class="rounded shadow-3d">
          </div>
          <div class="col-md-7 col-xl-6">
            <div class="row justify-content-center">
              <div class="col-xl-8 col-lg-10">
                <div class="my-3">
                  <span class="h1">Was wir dir bieten?</span>
                </div>
                <p class="lead">Du willst dich und deine Follower regelmäßig mit neuem Content beglücken? Und dabei noch das ein oder andere Produkt kostenlos zum Testen abstauben? Dann bist du bei den WunderBrudis genau richtig.</p>
                <p class="lead mb-0">Wir bringen dich dank unserer Plattform mit den richtigen Brands zusammen. Und das Beste: für dich als Influencer ist die Nutzung kostenlos!</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container" data-aos="fade-up">
        <div class="row align-items-center justify-content-around">
          <div class="col-md-5 col-xl-6 mb-4 mb-md-0">
            <img src="{{ asset('images/static') }}/social-media-marketing-2-2.jpg" alt="Image" class="rounded shadow-3d">
          </div>
          <div class="col-md-7 col-xl-6">
            <div class="row justify-content-center">
              <div class="col-xl-8 col-lg-10">
                <div class="my-3">
                  <span class="h1">Die BrudiCademy</span>
                </div>
                <p class="lead">Lass dich von den Ehrenmännern (und Ehrenfrauen) unterstützen. Unsere Expert*innen zeigen dir das 1x1 eines jeden Influencers. Challenge dein Wissen mit Quizzen und finde heraus, wie du deine Postings verbessern und rechtssichere Inhalte kannst. Damit kannst du bei unseren Partnerunternehmen richtig punkten!</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container" data-aos="fade-up">
        <div class="row align-items-center justify-content-around">
          <div class="col-md-5 col-xl-6 mb-4 mb-md-0">
            <img src="{{ asset('images/static') }}/social-media-marketing-2.jpg" alt="Image" class="rounded shadow-3d">
          </div>
          <div class="col-md-7 col-xl-6">
            <div class="row justify-content-center">
              <div class="col-xl-8 col-lg-10">
                <div class="my-3">
                  <span class="h1">Werde zum Produkttester.</span>
                </div>
                <p class="lead">Professionalisiere dein Hobby, steigere deine Reichweite und erhalte coole Produkte zum Testen. Die WunderBrudis bieten dir eine große Auswahl an Kampagnenpartnern, die nur auf dich, deinen Testbericht und deine Community warten.</p>
                <p class="lead mb-0"></p><p></p>
              </div>
        ...
        <div style="padding-top: 90px;">
          <a href="/register" class="btn btn-primary btn-lg btn-block">🚀 Jetzt kostenfrei & unverbindlich starten</a>
        </div>
      </div>
    </section>
    <section class="p-0">
        ...
        <div class="row mb-3">
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="NaN">
            <div class="card card-lg card-body align-items-center">
              <span class="badge badge-primary badge-top">✌️</span>
              <img src="{{ asset('images/static') }}/ruben.jpeg" alt="Ruben" class="avatar avatar-xlg mb-3">
              <h5 class="mb-0">Ruben</h5>
