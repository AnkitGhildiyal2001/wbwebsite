    ...
    <head>
        ...
        <style>
            ...
            @media screen and (-webkit-device-pixel-ratio), screen and (-moz-device-pixel-ratio){
                .sub-story__image,.sub-story__content{
            ...
            @media only screen and (max-width: 400px){
                .featured-story--top table,.featured-story--top td{
                    text-align:left
                }
                .featured-story--top__heading td,.sub-story__heading td{
                ...
                .featured-story__copy td,.sub-story__copy td{
                    font-size:14px !important;
                    line-height:20px !important
                }
                .sub-story table,.sub-story td{
                    text-align:center
                }
                .sub-story__hero img{
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td class="header header--left" style="padding: 20px 10px;" align="left">
                                                                    <a href="{{ url('/') }}">
                                                                        <img class="header__logo" src="{{ asset('images/logo/logo_small.png') }}" alt="WunderBrudis" style="display: block; border: 0;" height="68"/>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                ...
                                <table cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td align="center" style="font-family: Geneva, Tahoma, Verdana, sans-serif; font-size: 14px; line-height: 18px; color: #738597; padding: 0 20px 40px;">
                                            <br />
                                            <br />
                                            WunderBrudis UG, Armstr 14, 45355 Essen
                                            <br />
                                            <a href="{{ url('/impressum') }}" style="color: #7367f0;">Impressum</a> •
                                            <a href="{{ url('/datenschutz') }}" style="color: #7367f0;">Datenschutz</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
